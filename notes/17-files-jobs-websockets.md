...
[Previous](16-middleware-and-cors.md) · [Course map](00-course-guide.md) · [Next](18-testing.md)
...
**Beginner:** Upload hello and verify five bytes.
**Intermediate:** Upload a text file exceeding one MiB and expect 413; declared image type should give 415.
**Challenge:** Guarantee order-confirmation work survives a web-process crash after the order commits.
