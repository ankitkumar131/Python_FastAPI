...
[Previous](10-database-foundations.md) · [Course map](00-course-guide.md) · [Next](12-sql-servers-and-migrations.md)
...
**Beginner:** Prove persistence by restarting after creation.
**Intermediate:** Trigger a duplicate 409, then successfully create a different name.
**Challenge:** Add a maximum-price query filter.
...
Line 1 declares bounded inputs and the dependency. Line 2 builds filtered, ordered, bounded SQL. Line 3 executes it. GET `/products?max_price=3000` returns only matching products; negative max_price → 422. No imports beyond the complete file are needed.
