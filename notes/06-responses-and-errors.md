...
[Previous](05-pydantic.md) · [Course map](00-course-guide.md) · [Next](07-crud.md)
...
The declared model filters password_hash from the response; real code should also minimize secret handling.
