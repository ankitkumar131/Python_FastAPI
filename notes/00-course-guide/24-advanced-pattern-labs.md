...
[Course map](./) · [Reference](23-reference-and-troubleshooting.md)
...
Run with the chapter 15 JWT\_SECRET configured: `python -m uvicorn examples.scoped_access:app --reload`. Accounts/orders remain in-memory and single-process: this is an access-policy lab, not production storage.
