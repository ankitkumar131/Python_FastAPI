...
[Previous](01-python-prerequisites.md) · [Course map](./) · [Next](03-fastapi-first-application.md)
...
Valid: `{"tags":["paper"],"active":true,"description":null}`. Invalid: `{'active': True,}` because single quotes, Python boolean spelling and a trailing comma are not JSON syntax.
