...
[Previous](18-testing.md) · [Course map](./) · [Next](20-configuration-logging-security.md)
...
**Beginner:** Add an `/about` route in main reporting this service's name. **Intermediate:** Explain which layer should map ProductMissing to 404. **Challenge:** Add stock reservation plus order creation without committing half the operation.

## Expected Result / Solution

Inside create\_app, before `return app`, add:
