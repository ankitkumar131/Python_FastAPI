...
If port 5432 busy, stop local Postgres. The app must use SPRING\_DATASOURCE\_URL from compose.
...
SPRING\_DATASOURCE\_URL maps to spring.datasource.url.

**Simple Explanation:**

SPRING\_DATASOURCE\_URL maps to spring.
...
**Next:** [Day 30](day-30-final-capstone.md)
