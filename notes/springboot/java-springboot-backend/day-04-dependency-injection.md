...
**How?** A singleton is created once, so a constructor-injected prototype is also created once — not what you wanted. Use ObjectFactory, Provider, or @Lookup.
...
Does @Primary on the decorator hide the inner bean from List? (No — both exist unless you don’t expose inner as a bean.)
...
**Next:** [Day 5](day-05-spring-boot-fundamentals.md)
