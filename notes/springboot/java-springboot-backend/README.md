...
1. Open **one day folder**. Start with [`day-01-java-for-springboot/README.md`](day-01-java-for-springboot.md).
...
| Day | Folder                                                                | Topic                                   |
| --- | --------------------------------------------------------------------- | --------------------------------------- |
| 01  | [day-01-java-for-springboot](day-01-java-for-springboot.md)           | Backend fundamentals + Java refresher   |
| 02  | [day-02-java-for-springboot](day-02-java-for-springboot.md)           | Java concepts Spring actually uses      |
| 03  | [day-03-spring-fundamentals](day-03-spring-fundamentals.md)           | Spring, IoC, beans, ApplicationContext  |
| 04  | [day-04-dependency-injection](day-04-dependency-injection.md)         | Constructor / setter / field injection  |
| 05  | [day-05-spring-boot-fundamentals](day-05-spring-boot-fundamentals.md) | Spring Boot, Initializr, Maven, config  |
| 06  | [day-06-spring-boot-annotations](day-06-spring-boot-annotations.md)   | Core stereotype and config annotations  |
| 07  | [day-07-spring-mvc](day-07-spring-mvc.md)                             | DispatcherServlet and request lifecycle |
| 08  | [day-08-rest-apis](day-08-rest-apis.md)                               | HTTP, REST, status codes, JSON          |
| 09  | [day-09-first-rest-api](day-09-first-rest-api.md)                     | In-memory CRUD API + Postman            |
| 10  | [day-10-service-layer](day-10-service-layer.md)                       | Layered architecture                    |
| 11  | [day-11-dtos](day-11-dtos.md)                                         | Request/response DTOs and mapping       |
| 12  | [day-12-validation-exceptions](day-12-validation-exceptions.md)       | Bean Validation + global errors         |
| 13  | [day-13-mysql-fundamentals](day-13-mysql-fundamentals.md)             | SQL, tables, keys, joins                |
| 14  | [day-14-spring-data-jpa](day-14-spring-data-jpa.md)                   | JPA, Hibernate, repositories            |
| 15  | [day-15-mysql-crud-jpa](day-15-mysql-crud-jpa.md)                     | User Management API on MySQL            |
| 16  | [day-16-jpa-relationships](day-16-jpa-relationships.md)               | OneToOne, OneToMany, ManyToMany         |
| 17  | [day-17-advanced-jpa](day-17-advanced-jpa.md)                         | JPQL, N+1, pagination, locking          |
| 18  | [day-18-postgresql-fundamentals](day-18-postgresql-fundamentals.md)   | Postgres, UUID, JSONB, schemas          |
| 19  | [day-19-springboot-postgresql](day-19-springboot-postgresql.md)       | Employee Management API                 |
| 20  | [day-20-advanced-postgresql](day-20-advanced-postgresql.md)           | Indexes, transactions, Flyway           |
| 21  | [day-21-mongodb-fundamentals](day-21-mongodb-fundamentals.md)         | Documents, collections, BSON            |
| 22  | [day-22-spring-data-mongodb](day-22-spring-data-mongodb.md)           | MongoRepository CRUD                    |
| 23  | [day-23-advanced-mongodb](day-23-advanced-mongodb.md)                 | Aggregation, embed vs reference         |
| 24  | [day-24-spring-security](day-24-spring-security.md)                   | AuthN, AuthZ, filter chain              |
| 25  | [day-25-jwt-authentication](day-25-jwt-authentication.md)             | Register, login, JWT                    |
| 26  | [day-26-authorization-security](day-26-authorization-security.md)     | Roles, CORS, CSRF, token hygiene        |
| 27  | [day-27-testing](day-27-testing.md)                                   | JUnit, Mockito, MockMvc                 |
| 28  | [day-28-production-apis](day-28-production-apis.md)                   | OpenAPI, logging, Actuator, profiles    |
| 29  | [day-29-docker-deployment](day-29-docker-deployment.md)               | Dockerfile + Compose                    |
| 30  | [day-30-final-capstone](day-30-final-capstone.md)                     | E-Commerce backend + interview          |
...
| --------------------------- | -------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| 1. User Management CRUD API | In-memory → MySQL, validation, exceptions          | [projects/project-01-crud-api](projects/project-01-crud-api.md)                               |
| 2. Product Management API   | MySQL, JPA, DTO, pagination, filter, sort          | [projects/project-02-product-api](projects/project-02-product-api.md)                         |
| 3. Authentication API       | Register, login, JWT, roles                        | [projects/project-03-authentication-api](projects/project-03-authentication-api.md)           |
| 4. Blog API                 | MongoDB, posts, authors, comments, search          | [projects/project-04-mongodb-blog-api](projects/project-04-mongodb-blog-api.md)               |
| 5. Employee Management      | PostgreSQL, JPA, JWT, pagination                   | [projects/project-05-postgresql-employee-api](projects/project-05-postgresql-employee-api.md) |
| Capstone                    | E-Commerce backend (users, products, cart, orders) | [projects/final-project](projects/final-project.md)                                           |
...
Start here: [Day 1](day-01-java-for-springboot.md)
