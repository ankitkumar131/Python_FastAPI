...
Every `@Service` class is a normal class. Every `@GetMapping` method is a normal method. The container decides _when_ to call them.
...
**Next:** [Day 3](day-03-spring-fundamentals.md)
