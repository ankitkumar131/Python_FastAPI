...
[Previous](17-files-jobs-websockets.md) · [Course map](00-course-guide.md) · [Next](19-project-architecture.md)
...
Explicit null must not be discarded by exclude_none.
...
**Beginner:** Add an assertion that unknown product 999 returns 404.
**Intermediate:** Test that a caller-supplied ID is rejected at creation.
**Challenge:** Explain why a passing sequential refresh test does not prove multi-process atomicity.
