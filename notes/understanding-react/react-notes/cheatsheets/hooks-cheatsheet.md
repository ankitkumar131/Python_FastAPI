...
> **Part 18 · Reference · Cheatsheet 4 of 9** React 19. Rules first, then each hook: signature · when to use · gotcha · example.
...
| Provide a **typed hook**, not the raw context | one error message for the misuse, no \`                   |
