...
> **Part 18 · Reference · Cheatsheet 3 of 9** Baseline: TypeScript 5.x, React 19, `strict: true`. If `strict` is off, most of these guarantees do not exist — turn it on first.
...
7. **Type the&#x20;**_**values**_**, not the&#x20;**_**syntax**_: `Record<Status, string>` beats `{ [key: string]: string }`.
